Imports System.Data
Public Class EmployeesTemp
    Public TableName As String = "EmployeesTemp"
    ...
    Private Sub BasicForm_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        bm.Fields = New String() {SubId, "ArName", "Gender", "CityId", "AreaId", "TownId", "ReligionId", "Address", "DateOfBirth", "JobId", "Notes", "NationalId", "HomePhone", "Mobile", "Email", "EnName", "HiringDate"}
        bm.control = New Control() {txtID, ArName, Gender, CityId, AreaId, TownId, ReligionId, Address, DateOfBirth, JobId, Notes, NationalId, HomePhone, Mobile, Email, EnName, HiringDate}
