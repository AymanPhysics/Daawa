...
Public Class RPT2
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles Button2.Click
        ...
        rpt.paraname = {"Header", "@SeasonId", "@CityId", "@AreaId", "@TownId", "@SubTownId", "@CaseTypeId", "@IncomeTypeId", "@FromDate", "@ToDate", "CaseTypeName"}
        rpt.paravalue = {CType(CType(Parent, TabItem).Header, TabsHeader).MyTabHeader, Val(SeasonId.Text), Val(CityId.Text), Val(AreaId.Text), Val(TownId.Text), Val(SubTownId.Text), Val(CaseTypeId.Text), Val(IncomeTypeId.Text), FromDate.SelectedDate, ToDate.SelectedDate, CaseTypeName.Text}
        rpt.Header = Md.MyProject.ToString
        Select Case Flag
            Case 1
                rpt.RptPath = "CaseIncomeTypes.rpt"
        End Select
        rpt.ShowDialog()
    End Sub
    ...
    Private Sub txtID_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles CityId.KeyDown, AreaId.KeyDown, TownId.KeyDown, SubTownId.KeyDown, SeasonId.KeyDown, IncomeTypeId.KeyDown
    ...
    Private Sub IncomeTypeId_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles IncomeTypeId.KeyUp
        bm.ShowHelp("أنواع الدخل", IncomeTypeId, IncomeTypeName, e, "select cast(Id as varchar(100)) Id,Name from IncomeTypes ")
    End Sub
    ...
    Private Sub IncomeTypeId_LostFocus(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles IncomeTypeId.LostFocus
        bm.LostFocus(IncomeTypeId, IncomeTypeName, "select Name from IncomeTypes where Id=" & IncomeTypeId.Text.Trim())
    End Sub
