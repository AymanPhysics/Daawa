...
Public Class Sales
    Public TableName As String = "Sales"
    ...
    Private Sub Sales_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        bm.Fields = New String() {SubId, "Daydate", "Cost", "Notes"}
        bm.control = New Control() {txtID, DayDate, Cost, Notes}
...
Br:
            ...
            G.Grid.Rows(i).Cells(GC.Price).Value = dr(0)("SalesPrice")
    ...
    Sub FillControls()
        ...
        Dim dt As DataTable = bm.ExcuteAdapter("select * from SalesDetails1 where SalesId=" & txtID.Text)
        G.Grid.Rows.Clear()
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        bm.SaveGrid(G.Grid, "SalesDetails1", New String() {"SalesId"}, New String() {txtID.Text}, New String() {"Id", "Name", "Qty", "Price", "Value"}, New String() {GC.Id, GC.Name, GC.Qty, GC.Price, GC.Value}, New VariantType() {VariantType.Integer, VariantType.String, VariantType.Decimal, VariantType.Decimal, VariantType.Decimal}, New String() {GC.Id})
    ...
    Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        If bm.ShowDeleteMSG("هل أنت متأكد من المسح؟") Then
            ...
            bm.ExcuteNonQuery("delete from SalesDetails1 where SalesId='" & txtID.Text & "' ")
            btnNew_Click(sender, e)
        End If
    End Sub
    ...
    Private Sub Cost_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles Cost.KeyDown
    ...
    Private Sub GridKeyDown(ByVal sender As Object, ByVal e As Forms.KeyEventArgs)
        Try
            If G.Grid.CurrentCell Is G.Grid.Rows(G.Grid.CurrentRow.Index).Cells(GC.Id) Then
                Dim i As Integer = G.Grid.CurrentRow.Index
                If G.Grid.CurrentRow.Index = G.Grid.Rows.Count - 1 Then G.Grid.Rows.Add()
                G.Grid.CurrentCell = G.Grid.Rows(i).Cells(GC.Id)
                If bm.ShowHelpGrid("الأصنــــاف", G.Grid.Rows(G.Grid.CurrentRow.Index).Cells(GC.Id), G.Grid.Rows(G.Grid.CurrentRow.Index).Cells(GC.Name), e, "select cast(Id as varchar(100)) Id,Name from Items") Then
                    ...
                    GridCalcRow(sender, New Forms.DataGridViewCellEventArgs(G.Grid.CurrentRow.Index, GC.Id))
                End If
            End If
        Catch
        End Try
