...
Public Class StoreMovesIn
    Public TableName As String = "StoreMovesIn"
    ...
    Private Sub StoreMovesIn_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
...
Br:
    ...
    Sub FillControls()
        ...
        Dim dt As DataTable = bm.ExcuteAdapter("select * from StoreMovesInDetails1 where StoreMovesInId=" & txtID.Text)
        G.Grid.Rows.Clear()
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        bm.SaveGrid(G.Grid, "StoreMovesInDetails1", New String() {"StoreMovesInId"}, New String() {txtID.Text}, New String() {"Id", "Name", "Qty", "Price", "Value"}, New String() {GC.Id, GC.Name, GC.Qty, GC.Price, GC.Value}, New VariantType() {VariantType.Integer, VariantType.String, VariantType.Decimal, VariantType.Decimal, VariantType.Decimal}, New String() {GC.Id})
    ...
    Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        If bm.ShowDeleteMSG("هل أنت متأكد من المسح؟") Then
            ...
            bm.ExcuteNonQuery("delete from StoreMovesInDetails1 where StoreMovesInId='" & txtID.Text & "' ")
            btnNew_Click(sender, e)
        End If
    End Sub
