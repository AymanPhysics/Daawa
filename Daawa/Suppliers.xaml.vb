...
Public Class Suppliers
    ...
    Private Sub BasicForm_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        bm.Fields = New String() {SubId, SubName, "AccNo", "CityId", "Address", "HeadMaster", "Tel1", "Tel2", "Tel3", "Fax", "Bal0"}
        bm.control = New Control() {txtID, txtName, AccNo, CityId, Address, HeadMaster, Tel1, Tel2, Tel3, Fax, Bal0}
    ...
    Private Sub txtID_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles txtID.KeyDown, CityId.KeyDown, AccNo.KeyDown
